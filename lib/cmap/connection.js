...
class Connection extends mongo_types_1.TypedEventEmitter {
    ...
    onTimeout() {
        this.delayedTimeoutId = (0, node_timers_1.setTimeout)(() => {
...
/** @internal */
class SizedMessageTransform extends node_stream_1.Transform {
    ...
    _transform(chunk, encoding, callback) {
        if (this.connection.delayedTimeoutId != null) {
            (0, node_timers_1.clearTimeout)(this.connection.delayedTimeoutId);
