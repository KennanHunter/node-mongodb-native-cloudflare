...
class ConnectionPool extends mongo_types_1.TypedEventEmitter {
    ...
    ready() {
        ...
        (0, node_timers_1.clearTimeout)(this[kMinPoolSizeTimer]);
    ...
    clearMinPoolSizeTimer() {
        ...
        if (minPoolSizeTimer) {
            (0, node_timers_1.clearTimeout)(minPoolSizeTimer);
        }
    }
    ...
    ensureMinPoolSize() {
        ...
        if (this.totalConnectionCount < minPoolSize &&
            ...
            this.createConnection((err, connection) => {
                ...
                if (this[kPoolState] === exports.PoolState.ready) {
                    (0, node_timers_1.clearTimeout)(this[kMinPoolSizeTimer]);
                    this[kMinPoolSizeTimer] = (0, node_timers_1.setTimeout)(() => this.ensureMinPoolSize(), this.options.minPoolSizeCheckFrequencyMS);
                }
            });
        }
        else {
