...
class RTTPinger {
    constructor(monitor) {
        ...
        this[kMonitorId] = (0, node_timers_1.setTimeout)(() => this.measureRoundTripTime(), heartbeatFrequencyMS);
    }
    get roundTripTime() {
    ...
    close() {
        this.closed = true;
        (0, node_timers_1.clearTimeout)(this[kMonitorId]);
    ...
    measureAndReschedule(start, conn) {
        ...
        this[kMonitorId] = (0, node_timers_1.setTimeout)(() => this.measureRoundTripTime(), this.monitor.options.heartbeatFrequencyMS);
    }
...
class MonitorInterval {
    constructor(fn, options = {}) {
        ...
        this._executeAndReschedule = () => {
            if (this.stopped)
                return;
            if (this.timerId) {
                (0, node_timers_1.clearTimeout)(this.timerId);
            }
            this.isExpeditedCallToFnScheduled = false;
    ...
    _reschedule(ms) {
        ...
        this.timerId = (0, node_timers_1.setTimeout)(this._executeAndReschedule, ms || this.heartbeatFrequencyMS);
    }
}
